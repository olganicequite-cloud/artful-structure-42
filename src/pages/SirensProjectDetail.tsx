  ...
  return (
    <SiteLayout>
      <Seo
        ...
        description={`${project.title} by ${project.artist}. Featured project in the SIRENS — The Call of Silence exhibition, Berlin.`}
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <FadeIn delay={0.1}>
            ...
            <div className="space-y-4">
              ...
              <p className="text-editorial-caption text-foreground/60 leading-relaxed">
