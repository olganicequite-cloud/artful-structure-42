        ...
        <div className="relative w-full h-[45vh] sm:h-[50vh] md:h-[62vh] lg:h-[78vh] overflow-hidden">
          ...
          <div className="absolute z-10 bottom-5 right-5 sm:bottom-6 sm:right-6 md:bottom-8 md:right-8 lg:bottom-8 lg:right-8">
            <Link
              ...
              className="px-4 py-2 sm:px-5 sm:py-2 lg:px-6 lg:py-2.5 border border-white/80 text-white/90 text-xs lg:text-editorial-detail lg:border-foreground lg:text-foreground hover:bg-foreground hover:text-background transition-colors duration-300 inline-block"
            >
              Participate
            </Link>
          </div>
