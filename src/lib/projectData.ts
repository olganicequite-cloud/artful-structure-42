    ...
    images: [
      {
        ...
        caption: { title: "Confrontation III", medium: "Fine art print", dimensions: "40 × 40 cm" },
      },
      {
        src: yanaWork2,
        alt: "Yana Kaziulia — Liberation of Colors 2",
        caption: { title: "Confrontation IV", medium: "Fine art print", dimensions: "40 × 40 cm" },
      },
      {
        src: yanaWork3,
        alt: "Yana Kaziulia — Liberation of Colors 3",
        caption: { title: "Confrontation I", medium: "Fine art print", dimensions: "40 × 40 cm" },
      },
      {
        src: yanaWork4,
        alt: "Yana Kaziulia — Liberation of Colors 4",
        caption: { title: "Confrontation II", medium: "Fine art print", dimensions: "40 × 40 cm" },
      },
      {
        src: yanaWork5,
        alt: "Yana Kaziulia — Liberation of Colors 5",
        caption: { title: "Liberation", medium: "Fine art print", dimensions: "40 × 30 cm" },
      },
    ],
  },
  {
